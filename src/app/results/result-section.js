  ...
  return (
    ...
    >
      ...
      <div className="flex items-center mb-8 mt-4">
        <hr className="border-0 h-[0.3px] w-[100px] sm:w-[150px] md:w-[200px] rounded-full bg-white opacity-80 mr-6" />
        <h2
          className="text-white opacity-80 text-xl xs:text-2xl font-light"
          style={{
            fontFamily: "Average",
          }}
        >
        ...
        <hr className="border-0 h-[0.3px] w-[100px] sm:w-[150px] md:w-[200px] rounded-full bg-white opacity-80 ml-6" />
      </div>
      <p className="opacity-80 font-medium mb-8 text-lg sm:text-3xl text-white">{`$${fragrance.price_range.min} - $${fragrance.price_range.max}`}</p>
      <p className="text-white text-base sm:text-lg md:text-2xl font-normal opacity-90 max-w-[1000px] text-center mb-14">
